...
public class ViewActivity extends  AppCompatActivity  { 
	...
	private void initializeLogic() {
		...
		textview1.setText(getIntent().getStringExtra("rasm_key"));
		textview2.setText(getIntent().getStringExtra("nom_key"));
		imageview1.setImageResource(getResources().getIdentifier(getIntent().getStringExtra("malumot_key"), "drawable", getPackageName()));
